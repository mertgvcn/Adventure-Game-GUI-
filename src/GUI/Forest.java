...
public class Forest extends JFrame {
	...
	Obstacle obs = new Obstacle(c.getForest_lvl());
	 ...
	 * Create the frame.
	 */
	public Forest(GameProgress g, Character c) {
		this.g = g;
		this.c = c;
		num = 0;
		howManyLeft = 1;
		...
		JLabel lbl_txtRow1 = new JLabel(
				"   You are in the forest. You must kill the spider and take its eyes off to add ");
		...
		JLabel lbl_txtRow2 = new JLabel("it to the elixir necessary for your father's health .. Find the Spider !..");
		...
		if(c.getForest_lvl() == 1) {
			lbl_info.setText("  You're gonna fight against 3 wild bees!");
		}else if(c.getForest_lvl() == 2) {
			lbl_info.setText("  You're gonna fight against 2 grizzly bears!");
		}else if(c.getForest_lvl() == 3) {
			lbl_info.setText("  You're gonna fight against the Spider!");
		}
	...
	public void levelSystem(JLabel lbl_enemyHp, JLabel lbl_enemyDamage, JLabel lbl_enemyReward, JLabel lbl_uyari,
		...
		if (c.getForest_lvl() == 1) {
			...
			lbl_uyari.setText(3 - howManyLeft + " bee(s) left ..");
			howManyLeft++;
			if (num == 3) {
				lbl_uyari.setText("CheckPoint !");
				c.setForest_lvl(2);
				obs = new Obstacle(c.getForest_lvl());
				lbl_info.setText("  You're gonna fight against 2 grizzly bears!");
				newEnemyStats(obs, lbl_enemyHp, lbl_enemyDamage, lbl_enemyReward);
				howManyLeft = 1;
				num = 0;
			...
			newEnemyStats(obs, lbl_enemyHp, lbl_enemyDamage, lbl_enemyReward);
			lbl_uyari.setText(2 - howManyLeft + " grizzly bear left ..");
			howManyLeft++;
			if (num == 2) {
				lbl_uyari.setText("CheckPoint !");
				c.setForest_lvl(3);
			...
			c.setForest_lvl(c.getForest_lvl() + 1);
			JOptionPane.showMessageDialog(contentPane, "You took the Spider Eye and you found 200 coins !");
			c.getInv().setCoin(c.getInv().getCoin() + 200);
			g.setItm_spiderEye(true);
			Game_Menu gm = new Game_Menu(c);
			gm.setVisible(true);
			dispose();
