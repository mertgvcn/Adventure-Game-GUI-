...
public class Desert extends JFrame {
	...
	Obstacle obs = new Obstacle(6 + c.getDesert_lvl());
	 ...
	 * Create the frame.
	 */
	public Desert(GameProgress g , Character c) {
		this.g = g;
		this.c = c;
		num = 0;
		howManyLeft = 1;
		...
		JLabel lbl_txtRow1 = new JLabel("   You are in the desert. You must kill the desert snake and get his poison ! ");
		...
		JLabel lbl_txtRow2 = new JLabel("The last ingredient is snake posion .. Go and kill this snake !..\r\n");
		...
		JLabel lbl_info = new JLabel("  You're gonna fight against 3 scorpions !");
		if(c.getDesert_lvl() == 1) {
			lbl_info.setText("  You're gonna fight against 3 scorpions!");
		}else if(c.getDesert_lvl() == 2) {
			lbl_info.setText("  You're gonna fight against 2 big spider!");
		}else if(c.getDesert_lvl() == 3) {
			lbl_info.setText("  You're gonna fight against the Desert Snake!");
		}
		...
		btn_lightAttack.setBounds(11, 362, 227, 23);
		...
		btn_mediumAttack.setBounds(11, 384, 227, 25);
		...
		btn_heavyAttack.setBounds(11, 408, 227, 23);
	...
	public void levelSystem(JLabel lbl_enemyHp, JLabel lbl_enemyDamage, JLabel lbl_enemyReward, JLabel lbl_uyari,
		...
		if (c.getDesert_lvl() == 1) {
			...
			lbl_uyari.setText(3 - howManyLeft + " scorpion(s) left ..");
			howManyLeft++;
			if (num == 3) {
				lbl_uyari.setText("CheckPoint !");
				c.setDesert_lvl(2);
				obs = new Obstacle(6 + c.getDesert_lvl());
				lbl_info.setText("  You're gonna fight against 2 big spiders!");
				newEnemyStats(obs, lbl_enemyHp, lbl_enemyDamage, lbl_enemyReward);
				howManyLeft = 1;
				num = 0;
			}
			...
			newEnemyStats(obs, lbl_enemyHp, lbl_enemyDamage, lbl_enemyReward);
			lbl_uyari.setText(2 - howManyLeft + " big spider(s) left ..");
			howManyLeft++;
			if (num == 2) {
				lbl_uyari.setText("CheckPoint !");
				c.setDesert_lvl(3);
			...
			c.setDesert_lvl(c.getDesert_lvl() + 1);
			JOptionPane.showMessageDialog(contentPane, "You got the snake posion and you found 1000 coins !");
			c.getInv().setCoin(c.getInv().getCoin() + 1000);
			g.setItm_snakePosion(true);
			JOptionPane.showMessageDialog(contentPane, "Congratulations, you won the game! If you want, you can continue to fight in the arena. ");
			Game_Menu gm = new Game_Menu(c);
			gm.setVisible(true);
			dispose();
